...
proto.each = require('./each')
proto.equals = require('./equals')
proto.filter = require('./filter')
proto.getFacetingContext = require('./getFacetingContext')
proto.getFilteringContext = require('./getFilteringContext')
...
proto.hasValue = require('./hasValue')
