/* TEMP patch tapspace for scale-based navigation */
const tapspace = require('tapspace')
const ControlComponent = tapspace.components.ControlComponent
...
proto.bind = function (viewport) {
  ...
  this.onClickIn = (ev) => {
    ev.preventDefault()
    viewport.scaleBy(1 / scaleStep)
  }

  this.onClickOut = (ev) => {
    ev.preventDefault()
    viewport.scaleBy(scaleStep)
  }
